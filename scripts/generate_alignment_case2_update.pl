...
for($i=1;$i<=$n_gaps;$i++)
{
    ...
    `/scratch/jh7x3/multicom/tools/pulchra304/pulchra -c -s $outputfolder/Alignments/temp_NC_$i/ffffA.pdb`;
    ...
    if(!(-e "$outputfolder/Alignments/temp_NC_$i/ffffA.rebuilt.pdb"))
    {
      ...
      `/scratch/jh7x3/multicom/tools/scwrl4/Scwrl4 -i $outputfolder/Alignments/temp_NC_$i/ffffA.rebuilt.pdb -o  $outputfolder/Alignments/temp_NC_$i/ffffA_scwrl.pdb`;
...
for($i=1;$i<=$n_gaps;$i++)
{
    ...
    `/scratch/jh7x3/multicom/tools/pulchra304/pulchra -c -s $outputfolder/Alignments/temp_r_NC_$i/ffffB.pdb`;
    ...
    if(!(-e "$outputfolder/Alignments/temp_r_NC_$i/ffffB.rebuilt.pdb"))
    {
      ...
      `/scratch/jh7x3/multicom/tools/scwrl4/Scwrl4 -i $outputfolder/Alignments/temp_r_NC_$i/ffffB.rebuilt.pdb -o  $outputfolder/Alignments/temp_r_NC_$i/ffffB_scwrl.pdb`;
