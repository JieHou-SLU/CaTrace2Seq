...
for($i=1;$i<=$n_gaps;$i++)
{
    ...
    print RUNFILE "printf \"$installation_dir/tools/MTMG/mtmg $outputfolder/Alignments/temp_NC_$i/ align.pir temp_NC_$i $outputfolder/Alignments/temp_NC_$i/mtmg_refine/ $installation_dir/tools/MTMG/ /storage/htc/bdm/jh7x3/DeepRank/tools/R-3.2.0/bin/ 0 d\"\n\n";
  	print RUNFILE "$installation_dir/tools/MTMG/mtmg $outputfolder/Alignments/temp_NC_$i/ align.pir temp_NC_$i $outputfolder/Alignments/temp_NC_$i/mtmg_refine/ $installation_dir/tools/MTMG/ /storage/htc/bdm/jh7x3/DeepRank/tools/R-3.2.0/bin/ 0 d\n\n";
...
for($i=1;$i<=$n_gaps;$i++)
{
    ...
    print RUNFILE "printf \"$installation_dir/tools/MTMG/mtmg $outputfolder/Alignments/temp_r_NC_$i/ align.pir temp_r_NC_$i $outputfolder/Alignments/temp_r_NC_$i/mtmg_refine/ $installation_dir/tools/MTMG/ /storage/htc/bdm/jh7x3/DeepRank/tools/R-3.2.0/bin/ 0 d\"\n\n";
  	print RUNFILE "$installation_dir/tools/MTMG/mtmg $outputfolder/Alignments/temp_r_NC_$i/ align.pir temp_r_NC_$i $outputfolder/Alignments/temp_r_NC_$i/mtmg_refine/ $installation_dir/tools/MTMG/ /storage/htc/bdm/jh7x3/DeepRank/tools/R-3.2.0/bin/ 0 d\n\n";
